...
public class PingPong_CellularAutomataBP : MonoBehaviour
{
    Texture2D texA;
    Texture2D texB;
   // Texture2D inputTex;
    ...
    void Start()
    {
        ...
        cellularAutomataShader = Shader.Find("CMPM163/CA/RenderToTextureBP");
        ouputTextureShader = Shader.Find("CMPM163/CA/OutputTextureBP");
