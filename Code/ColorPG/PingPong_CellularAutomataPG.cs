...
public class PingPong_CellularAutomataPG : MonoBehaviour
{
    Texture2D texA;
    Texture2D texB;
   // Texture2D inputTex;
    ...
    void Start()
    {
        ...
        cellularAutomataShader = Shader.Find("CMPM163/CA/RenderToTexturePG");
        ouputTextureShader = Shader.Find("CMPM163/CA/OutputTexturePG");
