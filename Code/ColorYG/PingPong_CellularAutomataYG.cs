...
public class PingPong_CellularAutomataYG : MonoBehaviour
{
    Texture2D texA;
    Texture2D texB;
    //Texture2D inputTex;
    ...
    void Start()
    {
        ...
        cellularAutomataShader = Shader.Find("CMPM163/CA/RenderToTextureYG");
        ouputTextureShader = Shader.Find("CMPM163/CA/OutputTextureYG");
