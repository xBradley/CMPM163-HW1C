...
public class PingPong_CellularAutomataBY : MonoBehaviour
{
    Texture2D texA;
    Texture2D texB;
    //Texture2D inputTex;
    ...
    void Start()
    {
        ...
        cellularAutomataShader = Shader.Find("CMPM163/CA/RenderToTextureBY");
        ouputTextureShader = Shader.Find("CMPM163/CA/OutputTextureBY");
